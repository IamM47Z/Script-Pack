...
(function() {
    ...
    var RemoveAdsScripts = ( ) => {
        ...
        {
            if ( !scriptsArray[ i ].src.includes( "online.js" ) && !scriptsArray[ i ].src.includes( "propellerclick" ) && !scriptsArray[ i ].src.includes( "popads" ) && !scriptsArray[ i ].src.includes( "stremanp" ) )
                continue;
